[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(TaskManager.WebUI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(TaskManager.WebUI.App_Start.NinjectWebCommon), "Stop")]

namespace TaskManager.WebUI.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ISubTaskService>().To<SubTaskService>();
